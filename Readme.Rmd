...
with measures of social rigidity in the Ethnographic Atlas”. The `helper` file creates the data files. The `model` files run the Gradient Boosting Model, the Generalised Linear Model, and the Bayestraits model, respectively.
