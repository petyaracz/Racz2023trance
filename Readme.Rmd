...
lld = ld %>% 
  ...
  mutate(
    ...
    var_short = case_when(
      code == 1 ~ 'trance',
      code == 2 ~ 'possession',
      code == 3 ~ 'trance, possession,\ntrance iff possession',
      code == 4 ~ 'trance, possession,\ntrance if possession',
      code == 5 ~ 'trance, possession,\ntrance and possession',
      code == 6 ~ 'possession,\ntrance if possession',
      code == 7 ~ 'trance,\npossession if trance',
      code == 8 ~ 'none'
    ),
    coding = fct_reorder(var_name,code),
    var_short = fct_reorder(var_short,code)
  )
